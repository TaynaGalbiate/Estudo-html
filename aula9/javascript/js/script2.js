const somavalores = function(){
    ...
    v1 = parseInt(v1)   //Utilizamos o parseInt para converter String em número
    v2 = parseInt(v2)
...
/*Vamos criar um controle html usando javascript, este controle só existirá em tempo de execução,
ou seja, somente quando a página estiver rodando usaremoso comando createElement*/
...
//Adicionar o botão 4 ao corpo da página(body). Utilizaremos o comando append
